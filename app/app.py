...
if not st.session_state.authenticated:
    ...
    with tab_signup:
        ...
        st.caption(
            "📄 [Privacy Policy](https://www.ai-aurora.com/privacy) · "
        ...
        st.markdown(
            ...
            '<a href="https://www.ai-aurora.com/privacy" target="_blank">Privacy Policy</a>.',
            unsafe_allow_html=True,
        )
        ...
        if not consent:
            st.warning("Please accept the Privacy Policy to continue.")
    ...
    st.caption(
        ...
        "[Privacy Policy](https://www.ai-aurora.com/privacy) · "
        "[Terms & Conditions](https://ai-aurora.com/legal/terms) · "
        "Questions? privacy@ai-aurora.com"
    )
...
# Privacy Policy footer link (bottom of nav area)
st.markdown(
    "<div style='text-align:right; margin-top:-0.5rem;'>"
    "<a href='https://www.ai-aurora.com/privacy' target='_blank' style='color:#888; font-size:0.8rem; text-decoration:none;'>"
    ...
    with col3:
        if st.session_state.selected_section:
            ...
            if not st.session_state.evaluation_result:
                ...
                st.caption("*Scores are generated by an AI system and are always subject to review and approval by your instructor or trainer.*")
